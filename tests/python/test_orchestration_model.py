...
class OrchestrationModelTests(unittest.TestCase):
    ...
    def contract_records(self) -> list[tuple[object, dict]]:
        ...
        verification = {
            ...
            "repository_id": REPOSITORY_ID,
            "seal_id": seal_id,
            "materialization_id": "abababab-abab-4bab-8bab-abababababab",
            "materialization_path": "/tmp/materialization",
            "state": "passed",
            "commands": [{
                ...
                "timeout_seconds": 30,
                "process_identity": "controller:acacacac",
                ...
                "pre_jj_commit_id": "d" * 40,
                "pre_tree_digest": "e" * 64,
                "post_jj_commit_id": "d" * 40,
                "post_tree_digest": "e" * 64,
            }],
        ...
        evidence = {
            ...
            "digest": hashlib.sha256(
                b"Controller-observed normal exit."
            ).hexdigest(),

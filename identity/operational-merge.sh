#!/usr/bin/env bash
# operational-merge.sh — emit operation.md plus active Memory v2 learnings.
#
...
trap 'rm -f "$tmp"' EXIT
{
  ...
  echo ""
  echo "_Generated by \`operational-merge.sh\` from ~/.asha/operation.md + active learnings."
  echo "Edits will be overwritten. On Claude this same content loads via the"

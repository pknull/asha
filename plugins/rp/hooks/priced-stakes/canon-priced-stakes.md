<system-reminder>
This turn touches a PRICED STAKE — something the setting's source attaches a cost, a limit, or a closed list to (how you get out, what severance costs, how you get in, what the house does when it acts, what dies for good, Dooms).
...
The tell: **a costless answer to a priced question means the source went unread.** If what you are about to render imposes no cost, no key, no price, and no limit — stop and check whether the source already priced it.

Gap-filling elsewhere remains legitimate and expected. This applies only where the source has already decided.
</system-reminder>

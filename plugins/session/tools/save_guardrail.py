...
Both operations are idempotent and write a one-line summary of what was removed
...
def main() -> int:
    ...
    parser.add_argument("operation", choices=("strip-stubs", "dedup-keeper", "all"))

...
python "$ASHA_ROOT/plugins/write/skills/style-analyzer/scripts/analyze_style.py" source.txt

# Analyze directory of texts
python "$ASHA_ROOT/plugins/write/skills/style-analyzer/scripts/analyze_style.py" exemplars/

# JSON output for programmatic use
python "$ASHA_ROOT/plugins/write/skills/style-analyzer/scripts/analyze_style.py" source.txt --json

# Suppress specific cliche categories (e.g., fantasy project)
python "$ASHA_ROOT/plugins/write/skills/style-analyzer/scripts/analyze_style.py" source.txt --suppress shimmer_family shadow_worship

# Auto-read suppressions from voice.md
python "$ASHA_ROOT/plugins/write/skills/style-analyzer/scripts/analyze_style.py" source.txt --voice bible/voice.md

# List all available category IDs
python "$ASHA_ROOT/plugins/write/skills/style-analyzer/scripts/analyze_style.py" --list-categories
```

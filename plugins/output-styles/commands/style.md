...
Read all `.md` files from `$ASHA_ROOT/plugins/output-styles/styles/` directory and display:
...
1. Validate the style name exists in `$ASHA_ROOT/plugins/output-styles/styles/{name}.md`
